...
/*
	I'm keeping this file in because it contains a lot of work that should be moved over to the Frontline Game Test project,
	but it will not be run right now. In addition, we need to remove the SFML content, as we are moving over to our own window
	library and should write a texture library soon.
	-Kyle
*/
